...
package cloud::flexibleengine::rds::mode::memory;
...
my %metrics_mapping = (
    'rds002_mem_util' => {
        ...
        'nlabel' => 'rds.memory.utilization.percentage',
    }
);
...
Check RDS instances Memory metrics.

Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::rds::plugin  --mode=memory --region='eu-west-0'
