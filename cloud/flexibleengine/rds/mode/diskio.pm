...
package cloud::flexibleengine::rds::mode::diskio;
...
my %metrics_mapping = (
    'rds049_disk_read_throughput' => {
        'std_metric' => 'net_bytes_read',
        'output' => 'Disk Read Throughput',
        'label' => 'disk-read',
        'nlabel' => 'rds.disk.read.bytes.sec',
        'unit','B/s'
    },
    'rds050_disk_write_throughput' => {
        'std_metric' => 'disk_bytes_write',
...
Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::rds::plugin  --mode=diskio --region='eu-west-0'
...
Valid input is disk-write,disk-read
