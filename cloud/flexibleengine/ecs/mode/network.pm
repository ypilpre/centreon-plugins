...
package cloud::flexibleengine::ecs::mode::network;
...
my %metrics_mapping = (
    'network_incoming_bytes_rate_inband' => {
        'output' => 'Newtork Inband Incoming Bytes Rate',
        'label' => 'network-inband-in-bytes-rate',
        'nlabel' => 'ecs.network.inband.in.bytespersecond',
        'unit' => 'B/s',
    },
    'network_outgoing_bytes_rate_inband' => {
        'output' => 'Newtork Inband Outgoing Bytes Rate',
        'label' => 'network-inband-out-bytes-rate',
        'nlabel' => 'ecs.network.inband.out.bytespersecond',
        'unit' => 'B/s',
    },
    'network_incoming_bytes_aggregate_rate' => {
        'output' => 'Newtork Outband Incoming Bytes Rate',
        'label' => 'network-outband-in-bytes-rate',
        'nlabel' => 'ecs.network.outband.in.bytespersecond',
        'unit' => 'B/s',
    },
    'network_outgoing_bytes_aggregate_rate' => {
        'output' => 'Newtork Outband Outgoing Bytes Rate',
        'label' => 'network-outband-out-bytes-rate',
        'nlabel' => 'ecs.network.outband.out.bytespersecond',
        'unit' => 'B/s',
    },
...
Check ECS instances network metrics.
