...
package cloud::flexibleengine::css::mode::indices;
...
my %metrics_mapping = (
    'docs_count' => {
        ...
        'nlabel' => 'css.documents.count',
        'unit' => ''
    },
    'docs_deleted_count' => {
        'output' => 'Deleted Documents Count',
        'label' => 'deleted-documents-count',
        'nlabel' => 'css.documents.deleted.count',
        'unit' => '',
    },
    'indices_count' => {
        'output' => 'Indices Count',
        'label' => 'indices-count',
        'nlabel' => 'elb.indices.count',
        'unit' => '',
    },
    'total_shards_count' => {
        'output' => 'Total Shards Count',
        'label' => 'shards-count',
        'nlabel' => 'elb.shards.count',
        'unit' => '',
    },
    'primary_shards_count' => {
        'output' => 'Primary Shards Count',
        'label' => 'primary.shards-count',
        'nlabel' => 'elb.shards.primary.count',
        'unit' => '',
    }
...
sub check_options {
    ...
    $self->{ces_frame} = defined($self->{option_results}->{frame}) ? $self->{option_results}->{frame} : 300;
...
Check CSS Clusters instances Indices Stats.

Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::css::plugin  --mode=indices --region='eu-west-0'
...
Filter metrics (Can be 'documents-count', 'deleted-documents-count',
'shards-count','primary-shards-count','indices-count')
(Can be a regexp).

=item B<--warning-*> B<--critical-*>

Thresholds warning (Can be 'documents-count', 'deleted-documents-count',
'shards-count','primary-shards-count','indices-count').
=back
