...
my %metrics_mapping = (
    'nodes_count' => {
        'output' => 'Nodes Count',
        'label' => 'nodes-count',
        'nlabel' => 'css.nodes.count',
        'unit' => ''
    },
    'data_nodes_count' => {
        'output' => 'Data Nodes Count',
        'label' => 'data-nodes-count',
        'nlabel' => 'css.nodes.data.count',
        'unit' => '',
    },
    'coordinating_nodes_count' => {
        'output' => 'Coordination Nodes',
        'label' => 'coordination-nodes-count',
        'nlabel' => 'css.nodes.coordination.count',
        'unit' => '',
    },
    'master_nodes_count' => {
        'output' => 'Master Nodes',
        'label' => 'master-nodes-count',
        'nlabel' => 'css.nodes.master.count',
        'unit' => '',
    },
    'ingest_nodes_count' => {
        'output' => 'Client Nodes',
        'label' => 'client-nodes-count',
        'nlabel' => 'css.nodes.client.count',
        'unit' => '',
    }
...
Check CSS Clusters instances Nodes.

Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::css::plugin  --mode=nodes --region='eu-west-0'
 --instance-id='28616721-d001-480b-99d0-deccacf414e7' --filter-metric='Client' --statistic='average'
...
Filter metrics (Can be 'nodes-count', 'master-nodes-count',
'coordination-nodes','client-nodes','data-nodes')
(Can be a regexp).

=item B<--warning-*> B<--critical-*>

Thresholds warning (Can be 'nodes-count', 'master-nodes-count',
'coordination-nodes','client-nodes','data-nodes').
=back
