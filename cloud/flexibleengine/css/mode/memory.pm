...
package cloud::flexibleengine::css::mode::memory;
...
my %metrics_mapping = (
    'max_jvm_heap_usage' => {
        'std_metric' => 'jvm_max_mem_util',
        'output' => 'Max JVM Heap Usage',
        'label' => 'jvm-max-memory-utilization',
        'nlabel' => 'ecs.jvm.max.utilization.percentage',
        'unit' => '%'
    },
);
...
Check CSS instances Memory metrics.

Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::css::plugin  --mode=memory --region='eu-west-0'
--type='cluster' --engine='mysql' --instance_id='30191908-bf15-44e8-bf5c-ffa121bbd4ea' --filter=average
