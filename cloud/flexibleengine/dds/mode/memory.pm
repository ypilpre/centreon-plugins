...
package cloud::flexibleengine::dds::mode::memory;
...
my %metrics_mapping = (
    'mongo032_mem_usage' => {
        ...
        'nlabel' => 'dds.memory.utilization.percentage',
    }
);
...
Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::dds::plugin  --mode=memory --region='eu-west-0'
