...
package cloud::flexibleengine::elb::mode::backendstatus;
...
Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::elb::plugin  --mode=backendstatus --region='eu-west-0'
