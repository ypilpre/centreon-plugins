...
package cloud::flexibleengine::elb::mode::connections;
...
my %metrics_mapping = (
    'm1_cps' => {
        'output' => 'Concurrent Connections',
        'label' => 'concurrent-connections',
        'nlabel' => 'elb.connections.concurrent.count',
        'unit' => ''
    },
    'm2_act_conn' => {
        'output' => 'Active Connections',
        'label' => 'active-connections',
        'nlabel' => 'elb.connections.active.count',
        'unit' => '',
    },
    'm3_inact_conn' => {
        'output' => 'Inactive Connections',
        'label' => 'inactive-connections',
        'nlabel' => 'elb.connections.inactive.count',
        'unit' => '',
    }
...
Check ELB instances connections metrics.

Example: 
perl centreon_plugins.pl --plugin=cloud::flexibleengine::elb::plugin  --mode=connections --region='eu-west-0'
...
Filter metrics (Can be 'concurrent-connections', 'active-connecions',
'inactive-connecions')
(Can be a regexp).

=item B<--warning-*> B<--critical-*>

Thresholds warning (Can be 'concurrent-connections', 'active-connecions',
'inactive-connecions').
=back
