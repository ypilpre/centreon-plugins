...
package cloud::flexibleengine::elb::mode::traffic;
...
my %metrics_mapping = (
    'm5_in_pps' => {
        ...
        'label' => 'network-in-packet-sec',
        'nlabel' => 'elb.traffic.in.packetpersecond',
        'unit' => 'p/s'
    },
    'm6_out_pps' => {
        'output' => 'Outgoing Packets Rate',
        'label' => 'network-out-packet-sec',
        'nlabel' => 'elb.traffic.out.packetpersecond',
        'unit' => 'p/s',
    },
    'm7_in_Bps' => {
        'output' => 'Inbound Rate',
        'label' => 'network-in-bytes-sec',
        'nlabel' => 'elb.traffic.in.bytespersecond',
        'unit' => 'B/s',
    },
    'm8_out_Bps' => {
        'output' => 'Outbound Rate',
        'label' => 'network-out-bytes-sec',
        'nlabel' => 'elb.traffic.out.bytespersecond',
        'unit' => 'B/s',
    }
